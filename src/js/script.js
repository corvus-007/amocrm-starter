define(['jquery'], function($) {
  var CustomWidget = function() {
    ...
    this.callbacks = {
      render: function() {
        if (
          typeof AMOCRM.data.current_card != 'undefined' &&
          AMOCRM.data.current_card.id == 0
        ) {
        ...
        // simple layout
        var html =
          '<div class="xtratio_mywidget-wrap">This is widget example</div>' +
        ...
        utils.getTemplate('template_example', function(template) {
        ...
        utils.getTemplate('template_example_array', function(template) {
          $('.xtratio_mywidget-wrap').append(
            template.render({
